<template>
  ...
  <div class="q-pa-md row items-start q-gutter-md">
    <router-link :to="{ name: 'Content', params: { course: 'JavaScript' } }" style="text-decoration: none; color: inherit;">
 ...
 <router-link :to="{ name: 'Content', params: { course: 'DBMS' } }" style="text-decoration: none; color: inherit;">
    <q-card class="my-card">
      ...
      <q-card-section class="q-pt-none">
        <div class="text-caption text-grey">
          The fastest way for teams to create and share the world’s richest experiences. Create designs for websites, mobile apps,  and much more. Mac and Windows
        </div>
      </q-card-section>
...
<router-link :to="{ name: 'Content', params: { course: 'Adobe Photoshop' } }" style="text-decoration: none; color: inherit;">
    <q-card class="my-card">
      <q-img
