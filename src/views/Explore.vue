<template>
  ...
  <div class="q-pa-md row items-start q-gutter-md">
    <router-link
      :to="{ name: 'Content', params: { course: 'JavaScript' } }"
      ...
      <q-card class="my-card">
        ...
        <q-card-section>
          <div class="row no-wrap items-center">
            <div class="col text-h6">Javascript</div>
          </div>
    ...
    <router-link
      :to="{ name: 'Content', params: { course: 'Adobe XD' } }"
      style="text-decoration: none; color: inherit"
    >
      <q-card class="my-card">
        <q-img
        ...
        <q-card-section>
          <div class="row no-wrap items-center">
            <div class="col text-h6">Adobe Xd</div>
          </div>
        ...
        <q-card-section class="q-pt-none">
          <div class="text-caption text-grey">
            The fastest way for teams to create and share the world’s richest
            experiences. Create designs for websites, mobile apps, and much
            more. Mac and Windows
          </div>
        </q-card-section>
    ...
    <router-link
      :to="{ name: 'Content', params: { course: 'Adobe Photoshop' } }"
      style="text-decoration: none; color: inherit"
    >
      <q-card class="my-card">
        <q-img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbCHg7RVBfmMPJla6bxIzeLVfTFYtduPooYjwc9tmfdwHSlAWs9Syi5uBPYtmLk1BHwQY&usqp=CAU"
        />

        <q-card-section>
          <div class="row no-wrap items-center">
            <div class="col text-h6">Adobe Photoshop</div>
          </div>
        ...
        <q-card-section class="q-pt-none">
          <div class="text-caption text-grey">
            Create Beautiful Images, Graphics, Paintings, And 3D Artwork On Your
            Desktop And iPad. If You Can Dream It, You Can Make It With
            Photoshop.
          </div>
        </q-card-section>
